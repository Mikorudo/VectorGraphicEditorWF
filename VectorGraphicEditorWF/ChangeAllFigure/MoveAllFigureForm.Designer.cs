...
{
	partial class MoveAllFigureForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.numericUpDown1.Location = new System.Drawing.Point(100, 69);
			...
			this.numericUpDown2.Location = new System.Drawing.Point(100, 127);
			...
			this.button1.Text = "Переместить фигуры";
			this.button1.UseVisualStyleBackColor = true;
			this.button1.Click += new System.EventHandler(this.MoveFigure);
			// 
			// MoveAllFigureForm
			// 
			...
			this.Name = "MoveAllFigureForm";
			this.Text = "Перемещние фигур";
